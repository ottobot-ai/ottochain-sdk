...
export const CreateDelegation: MessageFns<CreateDelegation> = {
  encode(message: CreateDelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.spendLimit !== "") {
      writer.uint32(34).string(message.spendLimit);
    }
    ...
    if (message.delegatorSignature !== "") {
      writer.uint32(74).string(message.delegatorSignature);
    }
    if (message.nonce !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.delegatorSignature = reader.string();
          continue;
        }
        case 10: {
          if (tag !== 80) {
  ...
  fromJSON(object: any): CreateDelegation {
    return {
      ...
      expiresAt: isSet(object.expiresAt)
        ...
        : 0,
      delegatorSignature: isSet(object.delegatorSignature)
        ? globalThis.String(object.delegatorSignature)
        : isSet(object.delegator_signature)
        ? globalThis.String(object.delegator_signature)
        : "",
  ...
  toJSON(message: CreateDelegation): unknown {
    ...
    if (message.delegatorSignature !== "") {
      obj.delegatorSignature = message.delegatorSignature;
    }
    if (message.nonce !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateDelegation>, I>>(object: I): CreateDelegation {
    ...
    message.delegatorSignature = object.delegatorSignature ?? "";
...
function createBaseRevokeDelegation(): RevokeDelegation {
  return { delegationId: "", delegatorAddress: "", delegatorSignature: "", nonce: 0, reason: undefined };
}
...
export const RevokeDelegation: MessageFns<RevokeDelegation> = {
  encode(message: RevokeDelegation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.delegatorSignature !== "") {
      writer.uint32(26).string(message.delegatorSignature);
    }
    if (message.nonce !== 0) {
  ...
  encode(message: OttochainMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.message?.$case) {
      ...
      case "revokeDelegation":
        RevokeDelegation.encode(message.message.revokeDelegation, writer.uint32(58).fork()).join();
        break;
    }
    return writer;
  },
