...
function createBaseUpdateStakeRequest(): UpdateStakeRequest {
  return { identityId: "", address: "", amount: 0 };
}

export const UpdateStakeRequest: MessageFns<UpdateStakeRequest> = {
  encode(message: UpdateStakeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identityId !== "") {
      writer.uint32(10).string(message.identityId);
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateStakeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UpdateStakeRequest {
    return {
      identityId: isSet(object.identityId)
        ? globalThis.String(object.identityId)
        : isSet(object.identity_id)
  ...
  toJSON(message: UpdateStakeRequest): unknown {
    const obj: any = {};
    if (message.identityId !== "") {
      obj.identityId = message.identityId;
    }
  ...
  create<I extends Exact<DeepPartial<UpdateStakeRequest>, I>>(base?: I): UpdateStakeRequest {
    return UpdateStakeRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateStakeRequest>, I>>(object: I): UpdateStakeRequest {
    const message = createBaseUpdateStakeRequest();
    message.identityId = object.identityId ?? "";
    message.address = object.address ?? "";
    message.amount = object.amount ?? 0;
...
function createBasePenalizeIdentityRequest(): PenalizeIdentityRequest {
  return { identityId: "", contextId: "", reason: "", amount: 0 };
}

export const PenalizeIdentityRequest: MessageFns<PenalizeIdentityRequest> = {
  encode(message: PenalizeIdentityRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identityId !== "") {
      writer.uint32(10).string(message.identityId);
    }
    if (message.contextId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PenalizeIdentityRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PenalizeIdentityRequest {
    return {
      identityId: isSet(object.identityId)
        ? globalThis.String(object.identityId)
        : isSet(object.identity_id)
  ...
  toJSON(message: PenalizeIdentityRequest): unknown {
    const obj: any = {};
    if (message.identityId !== "") {
      obj.identityId = message.identityId;
    }
  ...
  create<I extends Exact<DeepPartial<PenalizeIdentityRequest>, I>>(base?: I): PenalizeIdentityRequest {
    return PenalizeIdentityRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PenalizeIdentityRequest>, I>>(object: I): PenalizeIdentityRequest {
    const message = createBasePenalizeIdentityRequest();
    message.identityId = object.identityId ?? "";
    message.contextId = object.contextId ?? "";
    message.reason = object.reason ?? "";
