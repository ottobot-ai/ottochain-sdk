...
export const identityAgentDef = defineFiberApp({
  ...
  transitions: [
    ...
    },
    {
      ...
      effect: {
        merge: [{ var: 'state' }, { reputation: { '+': [{ var: 'state.reputation' }, 2] } }],
      },
    },
    {
      from: 'ACTIVE',
      ...
      guard: { '==': [1, 1] },
      effect: {
        merge: [{ var: 'state' }, { reputation: { '+': [{ var: 'state.reputation' }, 5] } }],
      },
    },
    {
      from: 'ACTIVE',
      ...
      effect: {
        merge: [{ var: 'state' }, { status: 'CHALLENGED', challengedBy: { var: 'event.challenger' } }],
      },
    },
    {
      from: 'CHALLENGED',
    ...
    },
    {
      ...
      guard: { '==': [1, 1] },
      effect: {
        merge: [{ var: 'state' }, { status: 'SUSPENDED', suspendedAt: { var: '$ordinal' } }],
      },
    },
    {
      from: 'SUSPENDED',
      ...
      guard: { '==': [1, 1] },
      effect: {
        merge: [{ var: 'state' }, { status: 'PROBATION', probationStartedAt: { var: '$ordinal' } }],
      },
    },
    {
      from: 'PROBATION',
      ...
      guard: { '==': [1, 1] },
      effect: {
        merge: [{ var: 'state' }, { status: 'ACTIVE', probationStartedAt: null }],
      },
    },
    {
      from: 'ACTIVE',
