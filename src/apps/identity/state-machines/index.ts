...
export {
  ...
  type OracleState,
  type OracleEvent,
} from "./identity-oracle.js";
export {
  identityUniversalDef,
  type UniversalIdentityState,
  type UniversalIdentityEvent,
} from "./identity-universal.js";
...
export const IDENTITY_DEFINITIONS = {
  ...
  universal: () =>
    import("./identity-universal.js").then((m) => m.identityUniversalDef),
} as const;
