...
export const corpSecuritiesDef = defineFiberApp({
  ...
  createSchema: {
    required: ['securityId', 'entityId', 'shareClass', 'shareClassName', 'shareCount', 'parValue'] as const,
    properties: {
      securityId: {
        type: 'string',
  ...
  stateSchema: {
    properties: {
      ...
      issuancePrice: { type: 'number', nullable: true, description: 'Price per share at issuance', computed: true },
      issuanceDate: { type: 'string', format: 'date', nullable: true, computed: true },
      form: {
        type: 'string',
      ...
      authorization: { $ref: '#/definitions/Authorization', nullable: true, computed: true },
      issuanceDetails: { $ref: '#/definitions/IssuanceDetails', nullable: true, computed: true },
      transferHistory: { type: 'array', items: { $ref: '#/definitions/TransferRecord' }, computed: true },
      corporateActions: { type: 'array', items: { $ref: '#/definitions/CorporateAction' }, computed: true },
      retirementDetails: { $ref: '#/definitions/RetirementDetails', nullable: true, computed: true },
      status: {
        type: 'string',
  ...
  eventSchemas: {
    authorize_shares: {
      ...
      required: ['securityId', 'entityId', 'shareClass', 'shareClassName', 'shareCount', 'parValue', 'authorizedDate'] as const,
      properties: {
    ...
    issue_shares: {
      ...
      required: ['holderId', 'holderType', 'holderName', 'issuanceDate', 'form', 'boardResolutionRef', 'consideration'] as const,
      properties: {
        ...
        form: { type: 'string', enum: ['CERTIFICATED', 'BOOK_ENTRY', 'DRS'] as const },
    ...
    repurchase: {
      ...
      required: ['repurchaseDate', 'pricePerShare', 'boardResolutionRef'] as const,
      properties: {
    ...
    reissue_from_treasury: {
      ...
      required: ['holderId', 'holderName', 'holderType', 'reissueDate', 'boardResolutionRef'] as const,
      properties: {
        holderId: { type: 'string' },
        holderName: { type: 'string' },
        holderType: { type: 'string' },
    ...
    retire: {
      ...
      required: ['retiredDate', 'retirementMethod', 'boardResolutionRef'] as const,
      properties: {
    ...
    stock_split: {
      ...
      properties: {
        ...
        splitRatio: { type: 'string', description: "e.g., '2:1' for 2-for-1 split" },
    ...
    declare_dividend: {
      ...
      required: ['actionId', 'dividendType', 'recordDate', 'paymentDate', 'resolutionRef'] as const,
      properties: {
        actionId: { type: 'string' },
  ...
  definitions: {
    Holder: {
      ...
      properties: {
        holderId: { type: 'string' },
        holderType: { type: 'string', enum: ['INDIVIDUAL', 'ENTITY', 'TRUST', 'TREASURY'] as const },
        name: { type: 'string' },
        ...
        acquisitionMethod: {
          type: 'string',
          enum: ['ORIGINAL_ISSUANCE', 'PURCHASE', 'GIFT', 'INHERITANCE', 'STOCK_SPLIT', 'CONVERSION', 'EXERCISE'] as const,
        },
    ...
    Restrictions: {
      ...
      properties: {
        ...
        restrictionType: {
          ...
          items: {
            type: 'string',
            enum: ['RULE_144', 'SECTION_4(a)(2)', 'REG_D', 'REG_S', 'LOCK_UP', 'VESTING', 'RIGHT_OF_FIRST_REFUSAL'] as const,
          },
        },
        restrictionEndDate: { type: 'string', format: 'date', nullable: true },
        legends: { type: 'array', items: { type: 'string' }, description: 'Legend text on certificates' },
        vestingSchedule: {
          type: 'object',
          nullable: true,
          properties: {
    ...
    IssuanceDetails: {
      ...
      properties: {
        ...
        consideration: {
          type: 'object',
          properties: {
            type: { type: 'string', enum: ['CASH', 'PROPERTY', 'SERVICES', 'DEBT_CONVERSION', 'STOCK_CONVERSION'] as const },
            value: { type: 'number' },
    ...
    TransferRecord: {
      ...
      properties: {
        ...
        toHolderId: { type: 'string' },
        shares: { type: 'integer' },
        transferType: { type: 'string', enum: ['SALE', 'GIFT', 'INHERITANCE', 'INTERNAL'] as const },
    ...
    CorporateAction: {
      ...
      properties: {
        actionId: { type: 'string' },
        actionType: { type: 'string', enum: ['STOCK_SPLIT', 'REVERSE_SPLIT', 'STOCK_DIVIDEND', 'CONVERSION', 'RECLASSIFICATION'] as const },
    ...
    RetirementDetails: {
      ...
      properties: {
        retiredDate: { type: 'string', format: 'date' },
        retirementMethod: { type: 'string', enum: ['REPURCHASE', 'REDEMPTION', 'CANCELLATION', 'CONVERSION'] as const },
  ...
  states: {
    AUTHORIZED: { id: 'AUTHORIZED', isFinal: false, description: 'Shares authorized by charter but not yet issued' },
    ISSUED: { id: 'ISSUED', isFinal: false, description: 'Shares issued and held by a shareholder' },
    TREASURY: { id: 'TREASURY', isFinal: false, description: 'Shares repurchased and held by the company' },
    TRANSFERRED: { id: 'TRANSFERRED', isFinal: false, description: 'Transitional state during transfer between holders' },
    RETIRED: { id: 'RETIRED', isFinal: true, description: 'Shares cancelled and returned to authorized but unissued' },
  },
        ...
        merge: [
          { var: 'state' },
          {
            ...
            holder: {
              ...
              costBasis: { '*': [{ var: 'event.issuancePrice' }, { var: 'state.shareCount' }] },
            },
            restrictions: {
        ...
        and: [
          {
            or: [
              ...
              { '>=': [{ var: '$timestamp' }, { var: 'state.restrictions.restrictionEndDate' }] },
            ],
          },
          ...
          { var: 'state' },
          {
            ...
            transferHistory: {
              cat: [
                ...
                [
                  {
                    transferId: { cat: ['REPURCHASE-', { var: 'event.repurchaseDate' }] },
            ...
            holder: {
              ...
              acquisitionMethod: 'PURCHASE',
              costBasis: { '*': [{ var: 'event.pricePerShare' }, { var: 'state.shareCount' }] },
            },
          },
        ],
      },
                    ...
                    [
                      {
                        ...
                        sharesBeforeAction: { var: 'state.shareCount' },
                        sharesAfterAction: { '+': [{ var: 'state.shareCount' }, { var: 'event.stockShares' }] },
                        resolutionRef: { var: 'event.resolutionRef' },
                      },
                    ],
                  ],
                },
                shareCount: { '+': [{ var: 'state.shareCount' }, { var: 'event.stockShares' }] },
              },
            ],
          },
          { var: 'state' },
  ...
  crossReferences: {
    entity: { machine: 'corporate-entity', description: 'Parent corporate entity with share class definitions', foreignKey: 'entityId' },
    resolutions: { machine: 'corporate-resolution', description: 'Board resolutions authorizing securities actions', foreignKey: 'entityId' },
    shareholders: { machine: 'corporate-shareholders', description: 'Shareholder meetings for determining voting rights', foreignKey: 'entityId' },
  },
});
