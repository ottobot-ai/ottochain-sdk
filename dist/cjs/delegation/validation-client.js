...
exports.isValidationError = exports.isValidationSuccess = exports.createDelegationValidationClient = exports.DelegationValidationClient = void 0;
/**
 * Delegation Validation Client for SDK
 */
class DelegationValidationClient {
    constructor(config) {
        this.cache = new Map();
        this.config = {
            timeout: 5000,
...
exports.DelegationValidationClient = DelegationValidationClient;
/**
 * Create a delegation validation client with default configuration
 */
function createDelegationValidationClient(bridgeEndpoint, options) {
    return new DelegationValidationClient({
        bridgeEndpoint,
        ...options
    });
}
exports.createDelegationValidationClient = createDelegationValidationClient;
/**
 * Type guards for validation responses
 */
function isValidationSuccess(response) {
