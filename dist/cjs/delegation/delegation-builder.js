...
exports.DelegationBuilder = void 0;
...
class DelegationBuilder {
    ...
    static createDelegation(options) {
        const now = (0, utils_js_1.getCurrentTimestamp)();
        const defaultExpiry = (0, utils_js_1.addHours)(now, 1); // 1 hour default
        // Validate inputs
        ...
        return delegation_js_1.DelegationAuthority.create({
            delegationId: (0, utils_js_1.generateId)(),
    ...
    static createSessionKey(options) {
        ...
        const defaultSessionExpiry = (0, utils_js_1.addHours)(now, 0.5);
        ...
        return delegation_js_1.SessionKey.create({
    ...
    static createSignedIntent(options) {
        ...
        const defaultIntentExpiry = (0, utils_js_1.addHours)(now, 0.25);
        ...
        return delegation_js_1.SignedIntent.create({
            delegationId: options.delegationId,
    ...
    static createScope(options) {
        ...
        return delegation_js_1.DelegationScope.create({
    ...
    static validateDelegation(delegation) {
        ...
        if (delegation.approach === delegation_js_1.DelegationApproach.DELEGATION_APPROACH_UNSPECIFIED) {
...
exports.DelegationBuilder = DelegationBuilder;
