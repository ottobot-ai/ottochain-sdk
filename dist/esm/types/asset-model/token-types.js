...
})(TokenBehaviorType || (TokenBehaviorType = {}));
/**
 * Token operations that can be performed
 */
export var TokenOperation;
 ...
 */
export function getTokenBehaviorConfig(behaviorType) {
    return TOKEN_BEHAVIOR_CONFIGS[behaviorType];
}
/**
 * Extract TERV flags from behavior type
 */
export function getTERVFlags(behaviorType) {
 ...
 */
export function findTokenBehaviorType(flags) {
    const tervCode = [
 ...
 */
export function validateTokenOperation(behaviorType, operation, context) {
 ...
 */
export function getCompatibleTokenTypes(behaviorType) {
    const config = getTokenBehaviorConfig(behaviorType);
 ...
 */
export function canTokenTypesInteract(type1, type2) {
 ...
 */
export function getAllTokenBehaviorTypes() {
