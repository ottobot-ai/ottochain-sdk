 ...
 */
export const file_ottochain_apps_identity_v1_agent = /*@__PURE__*/ fileDesc("", [file_ottochain_v1_common, file_google_protobuf_timestamp]);
/**
 * Describes the message ottochain.apps.identity.v1.PlatformLink.
 * Use `create(PlatformLinkSchema)` to create a new message.
 */
export const PlatformLinkSchema = /*@__PURE__*/ messageDesc(file_ottochain_apps_identity_v1_agent, 0);
/**
 * Describes the message ottochain.apps.identity.v1.AgentIdentity.
 * Use `create(AgentIdentitySchema)` to create a new message.
 */
export const AgentIdentitySchema = /*@__PURE__*/ messageDesc(file_ottochain_apps_identity_v1_agent, 1);
/**
 ...
 */
export const AgentIdentityDefinitionSchema = /*@__PURE__*/ messageDesc(file_ottochain_apps_identity_v1_agent, 2);
/**
 ...
 */
export const AgentStateSchema = /*@__PURE__*/ enumDesc(file_ottochain_apps_identity_v1_agent, 0);
/**
 ...
 */
export const PlatformSchema = /*@__PURE__*/ enumDesc(file_ottochain_apps_identity_v1_agent, 1);
